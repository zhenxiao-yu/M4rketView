      ...
      {searchOpen && (
        ...
        >
          ...
          <motion.div
            ...
            animate="animate"
            exit="exit"
            className="relative w-full max-w-lg max-h-[calc(100dvh-3rem)] sm:max-h-[80vh] flex flex-col bg-gray-200 border border-cyan/30 rounded-2xl shadow-2xl overflow-hidden"
          >
